 ...
 */
router.post("/documents", upload.single("file"), LegalController.createOrUpdateLegalDoc);
 ...
 */
router.post("/bast/schedule", LegalController.scheduleBast);
 ...
 */
router.put("/bast/:bastId/complete", upload.single("file"), LegalController.completeBast);
