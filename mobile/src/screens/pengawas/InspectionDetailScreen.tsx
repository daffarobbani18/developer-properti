...
import { View, Text, StyleSheet, Image, Pressable, Alert, ScrollView, RefreshControl, Platform, StatusBar } from "react-native";
      ...
      >
        ...
        <View style={styles.contentPad}>
           ...
           <SlideInView direction="up" delay={50} duration={400}>
             <Text style={[styles.sectionTitle, { marginTop: errorMessage ? 16 : 0 }]}>Riwayat Defect</Text>
