...
for (const file of files) {
  ...
  // 3. Fix Modal padding in FieldMilestonesScreen and FieldDailyReportScreen
  if (file.includes("FieldMilestonesScreen.tsx")) {
      if (content.includes("<View style={{ flex: 1 }}>\n               <View style={styles.modalHeader}>")) {
          content = content.replace("<View style={{ flex: 1 }}>\n               <View style={styles.modalHeader}>", "<View style={{ flex: 1, paddingTop: safeTop }}>\n               <View style={styles.modalHeader}>");
          changed = true;
      }
  }
