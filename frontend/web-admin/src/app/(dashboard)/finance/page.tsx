...
export default function FinanceAdminPage() {
  return (
    <div className="space-y-6">
      ...
      <div>
        <h3 className="mb-4 text-sm font-bold text-zinc-900 uppercase tracking-wider">Status Verifikasi Pembayaran</h3>
        <div className="table-wrapper">
          ...
          <div className="divide-y divide-zinc-100">
            {paymentVerifications.map((pv) => {
              ...
              return (
                <div key={pv.buyer} className="group flex flex-col gap-3 px-6 py-4 transition-colors hover:bg-zinc-50/50 sm:grid sm:grid-cols-5 sm:items-center sm:gap-0">
                  <div className="col-span-2 flex items-center gap-3">
                    <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-zinc-100 to-zinc-50 text-sm font-bold text-zinc-600">{pv.buyer.charAt(0)}</div>
