    ...
    <div className="space-y-6">
      <div className="space-y-6">
            ...
            <CardContent className="p-4">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <Select value={filterTipe} onValueChange={setFilterTipe}>
                  <SelectTrigger className="w-full sm:w-44 h-10 rounded-lg border-zinc-200/80 bg-white/60 text-sm">
                    ...
                    <div className="space-y-4 mt-2">
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label className="text-sm text-zinc-700">Lead</Label>
                          <Select>
                        ...
                        <div className="space-y-2">
                          <Label className="text-sm text-zinc-700">Tipe</Label>
                          <Select>
                            <SelectTrigger className="h-10 rounded-lg border-zinc-200/80 bg-white/60">
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          className="rounded-lg border-zinc-200/80 bg-white/60 resize-none"
                          rows={3}
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          type="date"
                          className="h-10 rounded-lg border-zinc-200/80 bg-white/60"
                        />
                      </div>
                      <div className="flex justify-end gap-3 pt-2">
                        <Button
                          ...
                          className="rounded-lg border-zinc-200/80"
                        >
                          Batal
                        </Button>
                        <Button
                ...
                <div className="space-y-3">
                  {items.map((a) => {
                    ...
                    return (
                      <Card
                        key={a.id}
                        className="bg-white/80 backdrop-blur-md border border-zinc-200/50 shadow-sm rounded-xl transition-all duration-200 hover:shadow-md hover:border-blue-300/50"
                      >
                        <CardContent className="p-4">
        ...
        <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {upcoming.map((a) => {
                    ...
                    return (
                      <div
                        key={a.id}
                        className="flex items-start gap-3 rounded-lg bg-zinc-50/80 border border-zinc-200/40 p-3 transition-all duration-200 hover:bg-white/80"
                      >
                        <div
          ...
          <Card className="bg-white/80 backdrop-blur-md border border-zinc-200/50 shadow-sm rounded-xl">
            <CardContent className="p-4">
              <h3 className="font-[family-name:var(--font-heading)] text-sm font-semibold text-zinc-900 mb-3">
                Ringkasan Sales
              </h3>
              <div className="space-y-3">
                {["Rina", "Andi"].map((sales) => {
                  ...
                  return (
                    <div
                      key={sales}
                      className="flex items-center justify-between rounded-lg bg-zinc-50/80 border border-zinc-200/40 p-3"
                    >
                      ...
                      <Badge className="bg-zinc-100 text-zinc-600 font-medium text-xs rounded-md border-0">
                        {count} aktivitas
                      </Badge>
                    </div>
                  );
